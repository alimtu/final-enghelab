...
export default function StatisticsComponent({ data }) {
  ...
  return (
    <div className="w-full py-20 px-8 lg:px-20 bg-white overflow-hidden">
        ...
        <div className="relative mt-12">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-3 gap-6 p-6 lg:p-14">
            {items.map((option, index) => (
              <div
                key={index}
                className="bg-white/30 backdrop-blur-sm p-6 lg:p-12 rounded-lg shadow-lg text-center rtl"
              >
